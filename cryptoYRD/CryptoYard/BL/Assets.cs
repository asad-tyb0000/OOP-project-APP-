...
namespace CryptoConsole.BL
{
    public class Assets
    {
        ...
        public Assets(int id, int coinId, float amount, string assetStatus, int walletId)
        {
            this.id = id;
            this.CoinId = coinId;
            this.Amount = amount;
        ...
        // Function to update all properties from another Assets object
        public void UpdateAllProperties(Assets updatedAssets)
        {
            id = updatedAssets.id;
